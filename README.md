...
![PowerShell Version]( ![Module Version](A powerful, user-friendly PowerShell module for interacting with the Hammerspace Anvil API. This module provides a set of intuitive cmdlets to manage shares, monitor tasks, and perform raw API operations against a Hammerspace cluster.
Features
    ...
    Best Practices: Encourages secure credential storage and includes -WhatIf/-Confirm support for destructive operations.
...
git clone https://your-git-repository/hammerspace-powershell.git

2. Load the Module
Navigate to the project directory and import the module into your PowerShell session. Using -Force is helpful during development to reload your latest changes.
powershell

# Navigate to the directory where you cloned the repo
Set-Location ./hammerspace-powershell

# Import the module
Import-Module ./HammerspaceModule/HammerspaceModule.psd1 -Force
